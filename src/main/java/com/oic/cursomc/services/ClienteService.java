...
public class ClienteService {
	...
	public void deleteById(Integer id) {
		...
		try {
			...
			throw new DataIntegrityExeption	("Não é possível excluir uma categoria porque há entidades relacionadas");
		}
	}
	...
	public Cliente fromDTO(ClienteNewDTO objDto) {
		Cliente cli = new Cliente(null, objDto.getNome(), objDto.getEmail(), objDto.getCpfOCnpj(), TipoCliente.toEnum(objDto.getTipo()), pe.encode(objDto.getSenha()));
